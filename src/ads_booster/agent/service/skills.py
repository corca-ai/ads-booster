...
_MARKETING_SKILLS = (
    MarketingSkill(
        ...
        success_criteria=(
            ...
            "자동 검수와 사람의 최종 사용 승인, 생성과 외부 전달을 구분한다.",
        ),
        procedure=(
            ...
            "서비스가 정확한 제작 승인을 집행한다. 도구가 없으면 미설치 상태를 알리고 "
            ...
            "5. 결과의 캡션과 국가별 자산을 안내하고 사람의 사용 전 검토를 남긴다. "
            "배경 픽셀 완전 동일성이나 실제 앱 화면임을 검증 없이 주장하지 않는다. "
            "Slack 파일 전달·Threads 게시 등 외부 전달은 생성 승인과 별개다."
        ),
    ),
    MarketingSkill(
