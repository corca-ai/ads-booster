...
_MARKETING_SKILLS = (
    MarketingSkill(
        ...
        version="2",
        purpose="trace-post 귀여움 게시물의 KR·JP·TW 일정·캡션과 공통 배경 이미지를 만든다.",
        ...
        procedure=(
            ...
            "사용자가 지정한 날짜·모티프·장소를 확인한다. 지원하지 않는 카드나 템플릿은 "
            "지원한다고 추정하지 않는다.\n"
            ...
            "JP/TW L, 국가별 공통 프롬프트 C 순서로 생성한다. 화면의 일정·캡션은 현지화하며 "
            "손·손톱·장면의 픽셀 동일성을 요구하지 않는다. 실제 지침은 실행별 동결 사본을 따른다.\n"
