...
from ads_booster.web.chat_commands import WebCommandRequest, WebCommandResult
...
if TYPE_CHECKING:
    from ads_booster.web.agent_state import PendingApproval, WebAgentStateSnapshot
    from ads_booster.web.auth import Principal
    from ads_booster.web.chat_factory import WebAgentSessionFactory
    from ads_booster.workspace import MemberId, PrivateSessionRecord, WorkspaceId
