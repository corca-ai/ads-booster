...
title for every promotion_material.trace_items entry in request order — the entry's title field
as rendered, with no time prefix added. Wait for worker-created
