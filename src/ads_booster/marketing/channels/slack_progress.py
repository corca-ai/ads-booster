...
from ads_booster.marketing.channels.slack_conversations import Message

if TYPE_CHECKING:
    from ads_booster.marketing.channels.slack_conversations import SlackConversationStore
