...
# New workers keep draining already-persisted tasks at these frozen contracts. New tasks always use
# MARKETING_JUDGMENT_CAPABILITIES and callbacks opt into a legacy contract explicitly.
LEGACY_MARKETING_JUDGMENT_CAPABILITIES: Final[tuple[str, ...]] = ("creative_plan_v1",)
