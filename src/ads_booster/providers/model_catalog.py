...
DEFAULT_OPENAI_MODELS: Final[tuple[ProviderModel, ...]] = (
    ProviderModel(
        ...
        description="Efficient high-volume GPT-5.6 model",
        default_reasoning_level="medium",
        supported_reasoning_levels=(
            ProviderReasoningLevel(effort="none", description="No reasoning"),
            ...
            ProviderReasoningLevel(effort="xhigh", description="Extra-high reasoning"),
            ProviderReasoningLevel(effort="max", description="Maximum reasoning"),
        ),
    ),
    ProviderModel(
        slug="gpt-5.5",
