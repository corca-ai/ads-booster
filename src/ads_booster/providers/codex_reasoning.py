...
For a simple tool availability question, answer briefly from the current tool snapshot. Count
only actual descriptors as tools; ordinary conversation is not an additional tool. Do not invent
...
Pass only the resulting visual description as prompt.
