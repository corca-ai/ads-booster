...
from trace_capture.service.worker import (
    ServiceWorkerConfig,
    build_production_runner,
    create_service_worker,
)
from trace_capture.transport.http import create_http_client
from trace_capture.tunnel import CloudflaredTunnel, TunnelStartResult
...
if TYPE_CHECKING:
    ...
    from trace_capture.service.worker import AutomationServiceWorker
