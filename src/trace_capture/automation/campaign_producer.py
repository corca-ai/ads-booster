...
from trace_capture.automation.errors import CampaignRevisionError
from trace_capture.automation.models import QueueId, QueueState, QueueSubmission
from trace_capture.contracts.generation import MarketingContextBundle

if TYPE_CHECKING:
    from datetime import datetime

    from trace_capture.automation.campaign_models import CampaignRecord
