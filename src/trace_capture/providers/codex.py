...
from trace_capture.providers.model_catalog import available_models
...
class CodexResponsesClient:
    ...
    def respond(
        ...
        try:
            ...
            instructions = _instructions_with_runtime(self.instructions, self.model)
...
def _instructions_with_runtime(instructions: str, model: str) -> str:
    metadata = json.dumps(
