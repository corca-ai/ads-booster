...
from trace_capture.contracts import ContractModel, ErrorCode
...
def run(
    ...
    component_artifact: Annotated[Path | None, typer.Option()] = None,
    ...
    try:
        capture_port = build_run_capture_port(
            request=request,
