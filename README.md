...
permission, that request authorizes one exact creation; a second review/confirmation is unnecessary.
Questions and draft-only requests do not authorize creation. If additional consent is needed,
