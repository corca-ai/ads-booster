...
`contracts/tool_handoff.py` owns the bounded user-input handoff contract.
`agent/service/tool_handoff.py` projects a verified owner handoff into a host input intent;
