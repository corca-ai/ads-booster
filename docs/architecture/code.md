...
`schema_channel.py` and `migrations.py` own the v3 transition without editing historical schema
...
existing document, entry, revision and head tables. `schema_personal.py` owns the v4 transition and
does not edit the historical v3 schema.
